...
module.exports = {
    SESSION_ID: process.env.SESSION_ID === undefined ? 'PRABATH-MD~OKIjEC5Y#SUW7YNkcwYoIZekmk1CO92_oi5OaNbj5MkM8o9lTU9s' : process.env.SESSION_ID,
    PREFIX: process.env.PREFIX || '.',
    FOOTER: process.env.FOOTER || "> 𝐏ᴀɴᴅᴀ   𝐎ꜰᴄ   𝐁ᴏᴛ™",
    ALIVE_IMG: process.env.ALIVE_IMG || "https://files.catbox.moe/tpx16s.jpg",
...
WELCOME: process.env.WELCOME || 'false',
 ...
 AUTO_READ_STATUS: process.env.AUTO_READ_STATUS === undefined ? "true" : process.env.AUTO_READ_STATUS,
    ...
    ANTI_CALL: process.env.ANTI_CALL === undefined ? "falce" : process.env.ANTI_CALL,
